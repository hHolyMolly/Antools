...
function actionsHeader() {
  ...
  function showPassword() {
    const passwordContainer = document.querySelectorAll(
      ".popup-field__password .popup-field__item",
    );
    ...
    passwordContainer.forEach((password) => {
      password.addEventListener("click", function (e) {
        ...
        if (elementTarget.closest(".popup-field__password-show")) {
          if (
            elementTarget
              .closest(".popup-field__password .popup-field__item")
              .querySelector(".popup-field__input")
            ...
            elementTarget
              .closest(".popup-field__password .popup-field__item")
              .querySelector(".popup-field__password-show")
